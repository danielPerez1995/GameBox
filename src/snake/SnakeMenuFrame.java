...
public class SnakeMenuFrame extends javax.swing.JFrame implements  ActionListener{

    /**
     * Creates new form MainMenuFrame
     */
    public SnakeMenuFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Worm");

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/snake/snake-game.png"))); // NOI18N
    ...
    public void actionPerformed(ActionEvent e) {
        SnakeFrame game = new SnakeFrame();
         game.setupFrame();
       if(e.getActionCommand().equals("Slug")){
           game.setLevel(3);
       }
        
        
       if(e.getActionCommand().equals("Worm")){
          game.setLevel(2);
       }
        
       if(e.getActionCommand().equals("Python")){
          game.setLevel(1);
       }
