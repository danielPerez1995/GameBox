 ...
 * @author Tron
 */
public class Ultimate_TTT extends JFrame {
     private char turn = 'X';
    
    private Cell[][] cells = new Cell[9][9]; //Grid for the game
    
    JLabel labelStatus = new JLabel("X's turn to play"); //status of the game
    private JPanel panel = new JPanel(new GridLayout(9,9,0,0)); //will print the cells
...
public class Cell extends JPanel{
    ...
    protected void paintComponent(Graphics g)
    {
        ...
        try{
          Ximg = ImageIO.read(this.getClass().getResource("xSmall.png"));
          Oimg = ImageIO.read(this.getClass().getResource("oSmall.png"));
